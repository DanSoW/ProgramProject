/****************************************************************************
** Meta object code from reading C++ file 'wcheckbox.h'
**
...
#include <memory>
#include "../../LabOfWork/wcheckbox.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'wcheckbox.h' doesn't include <QObject>."
...
void WCheckBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WCheckBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject WCheckBox::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_WCheckBox.data,
    qt_meta_data_WCheckBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
